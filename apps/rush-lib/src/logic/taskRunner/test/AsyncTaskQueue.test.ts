...
describe('AsyncTaskQueue', () => {
  it('iterates tasks in topological order', async () => {
    const tasks = [
      new Task(new MockBuilder('a')!, TaskStatus.Ready),
      new Task(new MockBuilder('b')!, TaskStatus.Ready),
      new Task(new MockBuilder('c')!, TaskStatus.Ready),
      new Task(new MockBuilder('d')!, TaskStatus.Ready)
    ];
  ...
  it('handles concurrent iteration', async () => {
    const tasks = [
      ...
      new Task(new MockBuilder('c')!, TaskStatus.Ready),
      new Task(new MockBuilder('d')!, TaskStatus.Ready),
      new Task(new MockBuilder('e')!, TaskStatus.Ready)
    ];
