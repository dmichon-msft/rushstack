...
export class ProjectChangeAnalyzer {
  ...
  private readonly _projectStateCache: Map<ReadonlyMap<string, string>, string> = new Map();
   ...
   * @internal
   */
  public _hashProjectDependencies(packageDeps: ReadonlyMap<string, string>): string {
